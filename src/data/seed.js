...
export const seedCourses = [
  ...
  },
  {
    ...
    unlockLevel: null,
    lessons: [
      { id: 'gh-1', title: 'The sher — a couplet that turns', done: false },
      { id: 'gh-2', title: 'The ghazal — couplets under one music', done: false },
      { id: 'gh-3', title: 'Radif — the refrain', done: false },
      { id: 'gh-4', title: 'Qafia — the rhyme before it', done: false },
      { id: 'gh-5', title: 'The matla — your opening sher', done: false },
      { id: 'gh-6', title: 'Beher — short and long syllables', done: false },
      { id: 'gh-7', title: 'Taqti — scanning a line', done: false },
      { id: 'gh-8', title: 'Building a full ghazal', done: false },
      { id: 'gh-9', title: 'The maqta & your takhallus', done: false },
      { id: 'gh-10', title: 'Gul, bulbul & the masters', done: false },
    ],
  },
  {
    id: 'character-voice',
